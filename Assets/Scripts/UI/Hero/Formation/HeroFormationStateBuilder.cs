...
namespace IdleGame.UI.Hero.Formation
{
    public static class HeroFormationStateBuilder
    {
        ...
        private static readonly Color EmptySlotColor = new Color(0.18f, 0.22f, 0.31f, 1f);
        ...
        private static readonly Color LockedActionColor = new Color(0.24f, 0.25f, 0.28f, 1f);
        private static readonly Color RemoveActionColor = new Color(0.58f, 0.12f, 0.12f, 1f);
        private static readonly Color AddActionColor = new Color(0.88f, 0.72f, 0.20f, 1f);
        private static readonly Color LockedRuneSlotColor = new Color(0.18f, 0.20f, 0.26f, 1f);
        private static readonly Color EmptyRuneSlotColor = new Color(0.17f, 0.21f, 0.31f, 1f);
            ...
            Func<HeroDefinition, string> getShortHeroLabel)
        {
            ...
            return new HeroRosterCardState
            {
                ...
                DisplayText = HeroUiText.GetTraitBadge(hero.Definition.Trait)
                    ...
                    + "\n공 " + FormatNumber(hero.AttackPower, formatShortNumber) + "  체 " + FormatNumber(hero.MaxHp, formatShortNumber)
                    + "\n공속 " + hero.AttackSpeed.ToString("0.##") + "  이속 " + hero.MoveSpeed.ToString("0.#")
                    + "\n" + hero.Definition.PassiveLabel + "  " + starCostText + deployActionSuffix,
