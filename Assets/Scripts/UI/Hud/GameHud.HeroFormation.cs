    ...
    public sealed partial class GameHud
    {
        ...
        private void RefreshHeroFormationPanel()
        {
            ...
            HeroFormationPanelRefreshResult result = HeroFormationPanelPresenter.Refresh(new HeroFormationPanelPresenterArgs
            {
                ...
                TotemButton = heroHud.FormationTotemButton,
                TotemSecondButton = heroHud.FormationTotemSecondButton,
                TotemRemoveButton = heroHud.FormationTotemRemoveButton,
                TotemSecondRemoveButton = heroHud.FormationTotemSecondRemoveButton,
                TotemText = heroHud.FormationTotemText,
                TotemSecondText = heroHud.FormationTotemSecondText,
